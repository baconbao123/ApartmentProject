...
public class ViewRoomApart extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ViewRoomApart frame = new ViewRoomApart();
	 ...
	 * Create the frame.
	 */
	public ViewRoomApart() {
		setBackground(Color.WHITE);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 565, 595);
	...
	protected void btnCreateActionPerformed(ActionEvent e) {
		var addRoom = new FrameAddRoom();
		addRoom.setVisible(true);
		addRoom.setLocationRelativeTo(null);
		addRoom.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);

		addRoom.setFloorApartNum(ReadNumFloor.getText());
		addRoom.setApartNum(lblReadApNum.getText());
		addRoom.setIDApart(ReadID.getText());
	}
