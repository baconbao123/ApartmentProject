				...
				.addGroup(groupLayout.createSequentialGroup()
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(groupLayout.createSequentialGroup()
							...
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								.addGroup(groupLayout.createSequentialGroup()
									.addComponent(selectStatus, 0, 145, Short.MAX_VALUE)
									.addGap(41)
									.addComponent(inputRoom, GroupLayout.PREFERRED_SIZE, 92, GroupLayout.PREFERRED_SIZE)
									.addGap(43)
									...
									.addGap(219))
								.addComponent(scrollPane, GroupLayout.DEFAULT_SIZE, 1040, Short.MAX_VALUE)
								.addGroup(groupLayout.createSequentialGroup()
									.addComponent(lblDisplay, GroupLayout.PREFERRED_SIZE, 234, GroupLayout.PREFERRED_SIZE)
									.addPreferredGap(ComponentPlacement.RELATED)
									.addComponent(btnFirst, GroupLayout.DEFAULT_SIZE, 65, Short.MAX_VALUE)
									.addGap(57)
									.addComponent(btnPrev, GroupLayout.DEFAULT_SIZE, 57, Short.MAX_VALUE)
									.addGap(29)
									.addComponent(inputPage, GroupLayout.DEFAULT_SIZE, 84, Short.MAX_VALUE)
									.addGap(33)
									...
									.addGap(225)
									.addComponent(selectRow, 0, 81, Short.MAX_VALUE)))))
					.addGap(24))
		);
				...
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
						.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
							...
							.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
								.addComponent(lblDisplay, GroupLayout.PREFERRED_SIZE, 20, GroupLayout.PREFERRED_SIZE)
						...
						.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
							...
							.addComponent(selectRow, GroupLayout.PREFERRED_SIZE, 26, GroupLayout.PREFERRED_SIZE)))
					.addGap(24))
		);
