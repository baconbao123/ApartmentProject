...
public class ShowEditFees extends JPanel {
	...
	public ShowEditFees(int id, EventLoadTable event) {
		...
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
//				update water
				var waterUpdate = dao.updateMoney(fee.getWater_id(), Float.parseFloat(inputWater.getText()));
//				update elect
				var elecUpdate = dao.updateMoney(fee.getElectric_id(), Float.parseFloat(inputElectric.getText()));
//				update rent
				var rentUpdate = dao.updateMoney(fee.getRent_id(), Float.parseFloat(inputRent.getText()));
//				update rent
				var otherUpdate = dao.updateMoney(fee.getOther_id(), Float.parseFloat(inputOther.getText()));
//				update fee
