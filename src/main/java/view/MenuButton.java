...
public class MenuButton extends JButton {
	...
	private float alpha;
	private Color effectColor = new Color(0, 255, 127); // effect color when click menuItem
	...
	public MenuButton(Icon icon, String text) {
		...
		setIcon(icon);
		init();
		setBorder(new EmptyBorder(1, 17, 1, 1));
	}
	...
	private void init() {
		...
		setForeground(new Color(0, 0, 0)); // font color
	    setFont(new Font("Arial", Font.BOLD, 12)); // set font
	    setFocusPainted(false); // set focus = false
